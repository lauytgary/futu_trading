...
def backtest(df, lot_size, single_para_combination_dict, initial_capital, market):
    ...
    #### Strategy Specific ####
    candle_len = single_para_combination_dict['candle_len']
...
if __name__ == '__main__':
    ...
    for code in code_list:
        ...
        for single_para_combination_dict in all_para_combination_list:
            df, net_profit, num_of_trade, win_rate = backtest(df_dict[code], lot_size, single_para_combination_dict, initial_capital, market)
